...
public class TutorialUniverse implements Universe {
	...
	private int retry = 0;
	private int level;
	private DisplayableSprite intro;
	private DisplayableSprite updown;
	private DisplayableSprite leftright;
	private DisplayableSprite counter;
	...
	public TutorialUniverse (String mapPath, int level, int startRow, int startCol) {
		...
		intro = new UselessSprite(Level1Background.TILE_WIDTH * (3.53), Level1Background.TILE_HEIGHT * (9.5), complete, "res/tips/intro.png", 600, 200);
		sprites.add(intro);
		
		updown = new UselessSprite(Level1Background.TILE_WIDTH * (3.5), Level1Background.TILE_HEIGHT * (7), complete, "res/tips/updown.png", 600, 200);
		sprites.add(updown);
		
		leftright = new UselessSprite(Level1Background.TILE_WIDTH * (3.5), Level1Background.TILE_HEIGHT * (3.5), complete, "res/tips/leftright.png", 600, 200);
		sprites.add(leftright);
		
		counter = new UselessSprite(Level1Background.TILE_WIDTH * (5.5), Level1Background.TILE_HEIGHT * (5.8), complete, "res/tips/counter.png", 600, 200);
		sprites.add(counter);
